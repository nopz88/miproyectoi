		...
		<form>
			...
			<ul>
				...
				<li>
					...
					<input  name="fecha_de_nacimiento" placeholder="año">
				...
				<li>
					...
					<select name="estado">
						...
						$mysqli = new mysqli("localhost", "root","",  "bartolome");
					...
					$mysqli= new mysqli("localhost","root", "", "bartolome");
						...
						if (mysqli_connect_errno($mysqli)){
							echo "no sirve".mysqli_connect_errno();
						}

					$query= "select * from municipio where codigo_estado =1";
					$resultado= mysqli_query($mysqli,$query);
					$reg=mysqli_fetch_array($resultado);
			...
			<table width="454" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
			  ...
			  <tr>
			    <td height="54" colspan="2" align="center"><input type="submit" value="Enviar"> <input type="button" value="Borrar">
			      <a href="index.php">Ir a Inicio</a></td>
			  </tr>
			</table>
			</form>
	</div>
